...
<div class="header " id="header">
    ...
    <div class="header-body" id="header-body">
        <div class="container">
            <div class="row nav-menu align-items-center">
            <div class="col-12 col-lg-2 text-center d-block d-lg-none">
                    <a href="#" title="" class="img_ d-block logo" >
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="">Tại sao nên lựa chọn HRD</a></li>
                                <li><a href="">Các giải pháp triển khai</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">Nam</a>
                        ...
                        <li>
                            <a href="#">Nữ</a>
                            <ul>
                                <li><a href="">Nhà quản lý chuyên nghiệp</a></li>
                                <li><a href="">Đào tạo Live-learning</a></li>
                                <li><a href="">Các khóa học sắp khai giảng</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">Kính thời trang</a>
                            <ul>
                                <li><a href="">Tư vấn doanh nghiệp</a></li>
                                <li> <a href="" title="" class="">Cố vấn doanh nghiệp</a></li>
                            </ul>
                        </li>
                    </ul>
                    </div>
                ...
                <div class="col-12 col-lg-5">
                    <div class="menu menu-desktop menu-desktop--flex">
                        <ul>
                            <li>
                                <a href="#">Túi Xách</a>
                                <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="">Đào tạo Live-learning</a></li>
                                    <li><a href="">Các bộ chương trình đào tạo</a></li>
                                    <li><a href="">Gửi yêu cầu đào tạo</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">Quà Tặng</a>
